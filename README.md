...
Build a visually captivating website inspired by **[Zentry](https://zentry.com/)**, featuring scroll-triggered
...
```bash
git clone https://github.com/Juhan-Ahamed/award-winning-website.git
